...
package local.nicolas.letsfan.auth.ui.email;
...
import local.nicolas.letsfan.auth.ui.BaseHelper;
...
import local.nicolas.letsfan.auth.ui.email.field_validators.EmailFieldValidator;
import local.nicolas.letsfan.auth.ui.email.field_validators.PasswordFieldValidator;
import local.nicolas.letsfan.auth.ui.email.field_validators.RequiredFieldValidator;
import local.nicolas.letsfan.auth.util.signincontainer.SaveSmartLock;
