...
import local.nicolas.letsfan.auth.R;
...
import local.nicolas.letsfan.auth.ui.idp.AuthMethodPickerActivity;
import local.nicolas.letsfan.auth.util.CredentialsApiHelper;
import local.nicolas.letsfan.auth.util.EmailFlowUtil;
import local.nicolas.letsfan.auth.util.GoogleApiConstants;
import local.nicolas.letsfan.auth.util.PlayServicesHelper;
...
import static local.nicolas.letsfan.auth.ui.ResultCodes.RESULT_NO_NETWORK;
