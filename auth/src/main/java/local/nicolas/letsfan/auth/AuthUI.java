...
import local.nicolas.letsfan.auth.util.GoogleApiClientTaskHelper;
import local.nicolas.letsfan.auth.util.Preconditions;
import local.nicolas.letsfan.auth.util.signincontainer.SmartLockBase;
